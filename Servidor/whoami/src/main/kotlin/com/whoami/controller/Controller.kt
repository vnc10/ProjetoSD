...
import com.whoami.services.Game
import org.springframework.beans.factory.annotation.Autowired
import java.lang.Exception
import java.net.ServerSocket
import java.util.*

class Controller @Autowired constructor(val scoreRepository: ScoreRepository) {
    ...
    fun playGame(nameArquive: String) {
        val jogo = Game(this.players, this.subRound, this.totalPoints, nameArquive, this.scoreRepository)
        jogo.playGame()
    }
}